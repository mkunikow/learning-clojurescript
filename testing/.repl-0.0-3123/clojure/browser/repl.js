...
return (function (){
if(cljs.core.truth_((function (){var and__4604__auto__ = clojure.browser.repl.load_queue;
...
var script__$1 = (function (){var G__12320 = script;
(G__12320["type"] = "text/javascript");

(G__12320["onload"] = onload);

(G__12320["onreadystatechange"] = onload);

return G__12320;
})();
var script__$2 = (((opt_sourceText == null))?(function (){var G__12321 = script__$1;
(G__12321["src"] = src);

return G__12321;
})():(function (){var G__12322 = script__$1;
goog.dom.setTextContext(G__12322,opt_sourceText);
...
var reload_QMARK_ = (function (){var or__4616__auto__ = reload;
...
var path_12323 = (goog.dependencies_.nameToPath[src]);
delete goog.dependencies_.visited[path_12323];

delete goog.dependencies_.written[[cljs.core.str(goog.basePath),cljs.core.str(path_12323)].join('')];
} else {
}
